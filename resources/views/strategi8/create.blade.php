...
@section('title', 'Tambah Strategi 8')
@section('page-title', 'Tambah Data Strategi 8 - Wingback Penguatan Produk & Fungsi RM')
...
<div class="form-container">
    <form action="{{ route('strategi8.store') }}" method="POST">
        @csrf
